...
CONFIG = {
    ...
    'TRAIL_TRIGGER_PCT': 0.29,      # 트레일링 스탑 활성화 기준 수익률 (29% 수익 시 작동)
    'TRAIL_STOP_PCT': 0.02,         # 고점 대비 허용 하락폭 (고점 대비 -2% 시 익절)
    
    'BREAK_EVEN_TRIGGER': 0.11,     # 본전 보호 활성화 수익률 (11% 수익 시 손절가를 매수가 위로 상향)
    'BREAK_EVEN_BUFFER': 0.015,     # 본전 보호 시 최소 마진 (1.5%)
